 ...
 * 
 */
@WebServiceClient(name = "TestService", targetNamespace = "http://webservice.lanpang.com", wsdlLocation = "http://localhost:8080/services/TestService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTSERVICE_QNAME = new QName("http://webservice.lanpang.com", "TestService");
    ...
    public TestService getTestServiceImplPort() {
        return super.getPort(new QName("http://webservice.lanpang.com", "TestServiceImplPort"), TestService.class);
    }
    ...
    public TestService getTestServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.lanpang.com", "TestServiceImplPort"), TestService.class, features);
    }
